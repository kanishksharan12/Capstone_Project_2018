#!/bin/bash
# Simple script to start a new case on a forensics workstation.  Will create a new folder if needed
# and start two listeners: one for log information and the other to receive files. Intended to be
